  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        ...
        console.log("API Endpoint:", API_ENDPOINTS.PROJECTS);
        ...
        setError(`Failed to load projects from server: ${error.message}`);
      } finally {
        setLoading(false);
      }
    };
              ...
              >
                <div className="grid md:grid-cols-2 gap-8 relative z-10 p-8">
                  <div className="h-64 md:h-auto relative overflow-hidden rounded-2xl">
                    <motion.img
                      src={
                        project.imageUrl || project.image || "/images/web.webp"
                      }
                      alt={project.title}
